...
PGPASSFILE=~/.pgpass pg_dump -Fc  -h destaxa-document-validation.cluster-ro-cvgax45xgjcg.sa-east-1.rds.amazonaws.com -p 5432 -U postgres destaxa_document_validation | aws s3 cp - s3://rds-backups-automation/pg_dump/backup_destaxa_document_validation-2023-01-11.dump
